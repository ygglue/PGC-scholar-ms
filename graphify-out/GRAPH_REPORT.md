...
## Corpus Check
- 89 files · ~80,525 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 456 nodes · 859 edges · 48 communities detected
- Extraction: 63% EXTRACTED · 37% INFERRED · 0% AMBIGUOUS · INFERRED: 320 edges (avg confidence: 0.7)
...
Cohesion: 0.06
Nodes (18): getAvatarColor(), Dashboard(), Layout(), Profile(), QWidget, create_ambient_shadow(), FetchScholarDocsThread, FetchScholarsThread (+10 more)

### Community 3 - "Community 3"
Cohesion: 0.12
Nodes (7): handleView(), loadDocuments(), CacheService, clear_auth_token(), get_cache_service(), Loads existing list, replaces/adds items from new_items, and saves.         Use, Returns the latest 'updated_at' timestamp from the cached list.
...
Cohesion: 0.1
Nodes (5): loadStats(), NetworkStatusService, createBin(), loadBins(), SyncService
...
- **Why does `User` connect `Community 0` to `Community 11`, `Community 6`?**
  _High betweenness centrality (0.167) - this node is a cross-community bridge._
- **Why does `get_token_from_request()` connect `Community 11` to `Community 3`?**
