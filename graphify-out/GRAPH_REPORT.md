...
## Corpus Check
- 95 files · ~87,410 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 499 nodes · 943 edges · 50 communities detected
- Extraction: 62% EXTRACTED · 38% INFERRED · 0% AMBIGUOUS · INFERRED: 363 edges (avg confidence: 0.69)
...
Cohesion: 0.06
Nodes (59): AcademicRecord, AcademicRecordResponse, GradeInput, GradeSubmitRequest, ProspectusGradeResponse, submit_grades(), Announcement, AnnouncementReceipt (+51 more)

### Community 1 - "Community 1"
Cohesion: 0.06
Nodes (19): _get_machine_id(), load_auth_token(), save_auth_token(), _simple_decrypt(), _simple_encrypt(), create_ambient_shadow(), DashboardView, AutoLoginThread (+11 more)

### Community 2 - "Community 2"
Cohesion: 0.05
Nodes (32): createAnnouncement(), editAnnouncement(), getUserIdFromToken(), initUser(), loadAnnouncements(), handleView(), loadDocuments(), CacheService (+24 more)

### Community 3 - "Community 3"
Cohesion: 0.06
Nodes (21): getAvatarColor(), Dashboard(), Layout(), Profile(), QFrame, QMainWindow, QWidget, create_ambient_shadow() (+13 more)

### Community 4 - "Community 4"
Cohesion: 0.1
Nodes (7): clear_auth_token(), get_cache_service(), QDialog, ScholarsDirectoryView, create_ambient_shadow(), CreateBinDialog, SubmissionBinsView
...
Cohesion: 0.15
Nodes (7): BinDocumentsView, create_ambient_shadow(), DownloadDocThread, FetchBinDocsThread, ViewDocThread, QThread, FetchBinsThread
...
## Knowledge Gaps
- **18 isolated node(s):** `Create a new announcement (requires auth)`, `Run migrations in 'offline' mode.      This configures the context with just a U`, `Run migrations in 'online' mode.      In this scenario we need to create an Engi`, `verify_schema  Revision ID: 0061b74b1509 Revises: eeb1e72caa3a Create Date: 2026`, `drop_remark_type  Revision ID: 1516d15a1bef Revises: fc4b66102c67 Create Date: 2` (+13 more)
  These have ≤1 connection - possible missing edges or undocumented components.
- **Thin community `Community 26`** (2 nodes): `test_supabase_direct.py`, `test_upload()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 27`** (2 nodes): `main.py`, `health_check()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 28`** (2 nodes): `Settings.tsx`, `Settings()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Thin community `Community 38`** (1 nodes): `vite-env.d.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 39`** (1 nodes): `Modal.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 40`** (1 nodes): `apiService.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 41`** (1 nodes): `cacheService.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 42`** (1 nodes): `documentService.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Thin community `Community 45`** (1 nodes): `main.jsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 46`** (1 nodes): `api.js`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 47`** (1 nodes): `Generate initials: Juan + Dela Cruz -> "JDC"`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 48`** (1 nodes): `Generate consistent color from name hash`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 49`** (1 nodes): `# TODO: Implement actual API call via requests`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.

## Suggested Questions
_Questions this graph is uniquely positioned to answer:_

- **Why does `User` connect `Community 0` to `Community 9`, `Community 10`?**
  _High betweenness centrality (0.140) - this node is a cross-community bridge._
- **Why does `review_change()` connect `Community 12` to `Community 0`, `Community 2`?**
  _High betweenness centrality (0.091) - this node is a cross-community bridge._
- **Why does `get_token_from_request()` connect `Community 10` to `Community 2`?**
