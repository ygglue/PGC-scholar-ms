...
## Corpus Check
- 99 files · ~91,056 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 517 nodes · 960 edges · 54 communities detected
- Extraction: 62% EXTRACTED · 38% INFERRED · 0% AMBIGUOUS · INFERRED: 367 edges (avg confidence: 0.69)
...
Cohesion: 0.04
Nodes (36): createAnnouncement(), editAnnouncement(), getUserIdFromToken(), initUser(), loadAnnouncements(), handleToggleTheme(), init(), handleView() (+28 more)
...
Cohesion: 0.13
Nodes (7): clear_auth_token(), get_cache_service(), QDialog, create_ambient_shadow(), CreateBinDialog, FetchBinsThread, SubmissionBinsView
...
- **Why does `review_change()` connect `Community 0` to `Community 1`?**
