    ...
    <div className="min-h-screen w-full flex items-center justify-center bg-surface p-6">
      <div className="w-full max-w-[420px] bg-surface-container-lowest rounded-[28px] shadow-[0_8px_32px_rgba(0,0,0,0.04)] p-10 flex flex-col gap-10">
        <div className="text-center">
          <div className="w-16 h-16 bg-gradient-to-br from-primary-grad to-primary-grad-to rounded-[20px] mx-auto flex items-center justify-center mb-6 shadow-lg shadow-primary/20">
        ...
        <div className="flex flex-col gap-6">
          ...
          <button 
            ...
            className="w-full relative z-0 bg-surface-high hover:bg-surface-high text-on-surface font-semibold py-4 px-6 rounded-full transition-all active:scale-[0.98] min-h-[52px]"
          >
